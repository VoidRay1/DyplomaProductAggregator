# Generated by Django 4.2 on 2024-04-11 19:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('param_name', models.CharField(max_length=255, verbose_name='Param name')),
                ('param_val', models.TextField(blank=True, null=True, verbose_name='Param value')),
            ],
            options={
                'verbose_name': 'Param bot',
                'verbose_name_plural': 'Params bot',
                'ordering': ['param_name'],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('send_products', models.DateTimeField(blank=True, null=True)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='telegram_user', to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Arcgis',
            fields=[
                ('location', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='telegram_bot.location')),
