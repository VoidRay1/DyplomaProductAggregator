...
# from telegram_bot.handlers.application import process_telegram_event, TELEGRAM_BOT_USERNAME
from telegram_bot.handlers.application import TELEGRAM_BOT_USERNAME
